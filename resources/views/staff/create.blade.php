        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="fas fa-info-circle text-info"></i> Password must be at least 8 characters</li>
                    <li><i class="fas fa-info-circle text-info"></i> Select appropriate role</li>
                    <li><i class="fas fa-info-circle text-info"></i> Assign to an active truck if applicable</li>
                </ul>
            </div>
        </div>
    </div>
