                ...
                <form action="{{ route('bills.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="bottles_delivered" id="bottles_delivered" class="form-control @error('bottles_delivered') is-invalid @enderror" value="{{ old('bottles_delivered') }}" required min="1">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="empty_bottles_collected" id="empty_bottles_collected" class="form-control @error('empty_bottles_collected') is-invalid @enderror" value="{{ old('empty_bottles_collected') }}" required min="0">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" value="{{ old('amount') }}" required min="0" step="0.01">
                            </div>
                            @error('amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
            ...
            <div class="card-body">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        ...
                        Make sure to verify the customer's details before creating the bill.
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-info-circle text-primary"></i>
                        Count empty bottles carefully before collecting them.
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-info-circle text-primary"></i>
                        For credit payments, ensure the customer has sufficient credit limit.
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-info-circle text-primary"></i>
                        Print the bill immediately after creation for customer records.
                    </li>
                </ul>
            </div>
        </div>
